// The Jev-first section of the schema, as a module so every function bundle carries it (a file read of a
// computed path is not guaranteed to be traced into a Vercel function). THE SOURCE OF TRUTH for
