...
const HELD = (process.argv[2] ?? 'incredibles,big-hero-6,brave').split(',');
...
fs.writeFileSync(path.join(here, 'out', process.env.R8_NAME ?? 'who-flags.json'), JSON.stringify(out, null, 2));
