...
test('held-out gate (v10.2): the 16 seen films are dev (frozen and zootopia since round 7); every other slug needs --final-held-out-run and an intact out102/freeze.json', () => {
  assert.deepEqual([...DEV_FILMS].sort(), ['book-of-life', 'coco', 'frankenweenie', 'frozen', 'good-dinosaur', 'how-to-train-your-dragon', 'iron-giant', 'lion-king', 'moana', 'monsters-inc', 'nemo', 'princess-and-the-frog', 'tangled', 'up', 'wild-robot', 'zootopia']);
