...
test('held-out gate (v8): every non-dev slug needs --final-held-out-run and an intact out/freeze.json', () => {
  assert.deepEqual([...DEV_FILMS].sort(), ['frankenweenie', 'iron-giant', 'lion-king', 'monsters-inc', 'nemo', 'up', 'wild-robot']);
