...
const OUT = outDir();
const BASE = process.env.R5_BASE ? path.resolve(process.env.R5_BASE) : path.join(V8, 'round6', 'live'); // R5_BASE only to validate this scorer on round-4 films
const R5OUT = path.join(V8, 'round6', 'out');
