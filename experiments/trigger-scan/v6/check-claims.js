...
const POLICY = JSON.parse(fs.readFileSync(path.join(V6, 'policy.json'), 'utf8'));
...
const placements = {};
const raw = {};
const reused = { claims: 0, placements: 0, from: REUSE ? path.relative(V6, path.resolve(REUSE)) : null };
if (REUSE && !REFOLD) {
