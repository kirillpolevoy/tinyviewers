...
export const DENY = [
  ...
  // v10.2 additions: good-dinosaur (seen since v10.1), frozen and zootopia (seen since round 7)
  'arlo', 'poppa', 'butch', 'thunderclap', 'pterodactyl', 'raptor', 'velociraptor', 'caveboy',
  'elsa', 'anna', 'hans', 'olaf', 'kristoff', 'sven', 'arendelle', 'weselton', 'weaseltown', 'oaken', 'marshmallow', 'frozen heart', 'eternal winter', 'troll',
  'judy', 'hopps', 'wilde', 'bellwether', 'lionheart', 'bogo', 'clawhauser', 'weaselton', 'bonnie hopps', 'stu hopps', 'zootopia', 'night howler', 'otterton', 'manchas', 'mr. big', 'gazelle', 'bunnyburrow', 'tundratown',
];
