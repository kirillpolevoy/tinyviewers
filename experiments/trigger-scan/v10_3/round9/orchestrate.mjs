#!/usr/bin/env node
// ROUND 9 orchestrator: copy of v10_2/round8/orchestrate.mjs with v10.3's stage list (run-film.js STAGES: + mortal,
// describe2, checkdesc2, titles, checkdesc3, mergetext, each reserved at its run-film.js cap) and cwd = v10_3; the
// live chain is unchanged. Films from ./spend.mjs (kung-fu-panda, onward, croods).
...
const V102_STAGES = [
  ...
  ['classify', 0.25, true], ['sonnetq', 0.30, false], ['childcry', 0.01, true], ['resolve', 0.01, true], ['mortal', 0.04, true],
  ['select1', 0, false], ['moments', 0.02, true], ['select2', 0, false], ['describe', 0.15, false], ['checkdesc', 0.08, true],
  ['describe2', 0.12, false], ['checkdesc2', 0.06, true], ['titles', 0.04, false], ['checkdesc3', 0.03, true], ['mergetext', 0, false],
  ['select3', 0, false],
];
