...
const HELD = (process.argv[2] ?? 'frozen,zootopia,good-dinosaur').split(',');
...
fs.writeFileSync(path.join(here, 'out', process.env.R7_NAME ?? 'who-flags.json'), JSON.stringify(out, null, 2));
