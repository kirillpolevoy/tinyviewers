...
// v9: the ten films opened by rounds 1-4 are all DEV films (round 4 opened tangled, coco and
// how-to-train-your-dragon). Every other slug is held out.
export const DEV_FILMS = ['nemo', 'monsters-inc', 'lion-king', 'frankenweenie', 'wild-robot', 'iron-giant', 'up', 'tangled', 'coco', 'how-to-train-your-dragon'];
...
export function outDir() {
  const d = process.env.V9_OUT ? path.resolve(V8, process.env.V9_OUT) : path.join(V8, 'out');
