...
test('held-out gate (v9): every non-dev slug needs --final-held-out-run and an intact out/freeze.json', () => {
  assert.deepEqual([...DEV_FILMS].sort(), ['coco', 'frankenweenie', 'how-to-train-your-dragon', 'iron-giant', 'lion-king', 'monsters-inc', 'nemo', 'tangled', 'up', 'wild-robot']);
