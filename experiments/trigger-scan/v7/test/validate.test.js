...
test('v5: "touching" as physical contact is not a judgement word', () => {
  assert.deepEqual(judgementWords('A human child touching a monster could be deadly.'), []);
  assert.deepEqual(judgementWords('A touching goodbye.'), ['touching']);
});
