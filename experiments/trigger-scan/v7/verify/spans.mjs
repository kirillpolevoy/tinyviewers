...
const tags = JSON.parse(fs.readFileSync(path.join(V7, 'out', `${slug}.tags.r1.json`), 'utf8'));
const mom = JSON.parse(fs.readFileSync(path.join(V7, 'out', `${slug}.moments.r1.json`), 'utf8'));
