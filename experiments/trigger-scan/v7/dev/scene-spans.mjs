...
const V7 = path.resolve(here, '..'); const TS = path.resolve(V7, '..');
...
const run = readJson(path.join(V7, 'out', `${slug}.jev.r1.json`));
const saved = readJson(path.join(V7, 'out', `${slug}.moments.r1.json`));
