...
async function saveSubtitleToDatabase(supabase: any, movieId: string, subtitleContent: string, source: string) {
  try {
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Save to database
    const saveSuccess = await saveSubtitleToDatabase(supabase, movieId, subtitleContent, 'opensubtitles');
