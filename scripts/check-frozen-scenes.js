...
console.log("Frozen movies details:", frozenMovies?.map(m => ({ title: m.title, hasSubtitles: !!m.subtitles?.length, hasScenes: !!m.scenes?.length, subtitleLength: m.subtitles?.[0]?.subtitle_text?.length || 0 })));
